    ...
    return (
        ...
        id="videoInformationOverlay" onClick={videoInformationOverlayClicked}>
            <div className="videoInformation bg-white rounded-lg max-w-[60%] px-[30px] py-[10px]" id="videoInformation">
                ...
                <div className="description bg-gray-100 max-h-[280px] text-[18px] block mt-[4px] px-[10px] py-[5px] break-words overflow-y-auto border-black border-[1px] rounded-[4px]"
                id="description">
                    {description}
                </div>
